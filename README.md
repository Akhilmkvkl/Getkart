...
The website is a fashion products commerce platform mainly for Shoes,Watches and Sunglass, you can add products to your cart and wishlist and pay for them. If you want to try the checkout process, you can use the dummy card number/ upi/ Internet Bankinng provided by Razorpay for testing . 
also There is option for Paypal and COD payments
Please <u><b>DO NOT</b></u> provide real card number and data.



In order to access the admin panel on "adminlogin" you need to provide the admin email and password.

![This is an image](/getkarthome.jpg)
## Run
...
Now you can run `nodemon` in the terminal and the application should work.
...
The application displays different category of products such as Shoes,Sunglass and Watches.
...
- Manage users home page 
 ...
 Copyright 2022 © [Akhil M](https://https://github.com/Akhilmkvkl)
